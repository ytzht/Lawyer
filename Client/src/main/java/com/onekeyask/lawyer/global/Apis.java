...
//        String ShareLawyerUrl = "http://139.198.13.26/lawyer.html?id=";
    String ShareLawyerUrl = "http://www.zhimalawyer.com/app/lawyer.html?id=";
//        String ShareChatUrl = "http://139.198.13.26/chat.html?id=";
    String ShareChatUrl = "http://www.zhimalawyer.com/app/chat.html?id=";
    ...
    String TextChatServiceInfo = Apis.Base + "c/textChatServiceInfo";//1.22 图文咨询服务购买页
    ...
    String TelChatServiceInfo = Apis.Base + "c/telChatServiceInfo";//1.57 图文咨询服务购买页

    String CallDetail = Apis.Base + "c/conversation/callDetail";//1.57 图文咨询服务购买页
    String Callup = Apis.Base + "c/conversation/callup";//1.57 图文咨询服务购买页
