...
//                    showShort(red.getMsg());
    ...
    private void initBanner(final Banner banner) {
        ...
        banner_img.add(Apis.Base + "pic/1807");
...
//                            showShort(homePage.getAdList().get(position).getContent());
                            ...
                            switch (homePage.getAdList().get(position).getType()){
                                case 0:
                                    break;
                                case 1:
                                    break;
                                case 2:
                                    ...
                                    intent.putExtra("lawyerId", Integer.parseInt(homePage.getAdList().get(position).getContent()));
                                    startActivity(intent);

                                    break;
                                case 3:
                                    startActivity(FindLawyerActivity.class, "keyword", homePage.getAdList().get(position).getContent());

                                    break;
                                case 4:
                                    //发现详情页.26
                                    Intent intent1 = new Intent(getActivity(), AskDetailActivity.class);
                                    intent1.putExtra("cid", Integer.parseInt(homePage.getAdList().get(position).getContent()));
