...
public class DoubleListView<LEFTD, RIGHTD> extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    public DoubleListView<LEFTD, RIGHTD> leftAdapter(SimpleExtTextAdapter<LEFTD> leftAdapter) {
        mLeftAdapter = leftAdapter;
        lv_left.setAdapter(leftAdapter);
        return this;
    }

    public DoubleListView<LEFTD, RIGHTD> rightAdapter(SimpleExtTextAdapter<RIGHTD> rightAdapter) {
