 ...
 * 菜单条目适配器
 */
public abstract class SimpleExtTextAdapter<T> extends BaseBaseAdapter<T> {

    private final LayoutInflater inflater;

    public SimpleExtTextAdapter(List<T> list, Context context) {
        super(list, context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.lv_ext_item_filter, parent, false);
