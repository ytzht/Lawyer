    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == PhotoPicker.REQUEST_CODE) {
            if (data != null) {
                ...
                Log.d("=====", "onActivityResult: " + photoPath);
//                Toast.makeText(this, "photoPath "+photoPath, Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(this, "onActivityResult: requestCode + resultCode + data " + requestCode + resultCode + data, Toast.LENGTH_SHORT).show();
        }
    }
