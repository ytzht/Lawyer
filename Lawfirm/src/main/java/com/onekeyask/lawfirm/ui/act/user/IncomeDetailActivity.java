...
public class IncomeDetailActivity extends BaseToolBarActivity {
    ...
    private View contentView_month, contentView_year;
    ...
    private class IncomeAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            ...
            if (position == 0) {
                ...
                TimePickerView.OnTimeSelectListener selectListener = new TimePickerView.OnTimeSelectListener() {
                    @Override
                ...
                builder = new TimePickerView.Builder(IncomeDetailActivity.this, selectListener);
                Calendar startDate;
                startDate = Calendar.getInstance();
                startDate.set(2017, 0, 1);
                builder.setRangDate(startDate, Calendar.getInstance());
                ...
                ((ViewHolderHeader) holder).tv_year.setText(year + "年");
//                ((ViewHolderHeader) holder).ll_year.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        popupWindow = getPopwindow(contentView_year);
//                        popupWindow.showAsDropDown(((ViewHolderHeader) holder).ll_year);
//                    }
//                });
//                ((ViewHolderHeader) holder).ll_month.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        popupWindow = getPopwindow(contentView_month);
//                        popupWindow.showAsDropDown(((ViewHolderHeader) holder).ll_month);
//                    }
//                });

                ((ViewHolderHeader) holder).tv_month.setText(month + "月");
                ((ViewHolderHeader) holder).time_picker.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                ...
                contentView_month = LayoutInflater.from(getBaseContext()).inflate(R.layout.menu_month, null);
                contentView_year = LayoutInflater.from(getBaseContext()).inflate(R.layout.menu_year, null);
                final TextView tv_1 = (TextView) contentView_month.findViewById(R.id.tv_type_1);
                ...
                final TextView tv_2 = (TextView) contentView_month.findViewById(R.id.tv_type_2);
                ...
                final TextView tv_3 = (TextView) contentView_month.findViewById(R.id.tv_type_3);
        ...
        class ViewHolderHeader extends RecyclerView.ViewHolder {
            ...
            private LinearLayout ll_month, time_picker, ll_year;

            public ViewHolderHeader(View itemView) {
                super(itemView);
                time_picker = (LinearLayout) itemView.findViewById(R.id.time_picker);
                ll_month = (LinearLayout) itemView.findViewById(R.id.ll_month);
                ll_year = (LinearLayout) itemView.findViewById(R.id.ll_year);
