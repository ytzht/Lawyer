...
public class UserService {
    ...
    private static final String FirstHome = "_firstHome";
    ...
    public int getLawyerId() {
        ...
        return memberPrefs.getInt(LawyerId, 2);
    }
    ...
    public int getFirstHome() {
        SharedPreferences memberPrefs = context.getSharedPreferences(
                LawyerId, Context.MODE_PRIVATE);
        return memberPrefs.getInt(FirstHome, 1);
    }

    public void setFirstHome(int firstHome) {
        SharedPreferences memberPrefs = context.getSharedPreferences(
                LawyerId, Context.MODE_PRIVATE);
        memberPrefs.edit().putInt(FirstHome, firstHome).apply();
    }
