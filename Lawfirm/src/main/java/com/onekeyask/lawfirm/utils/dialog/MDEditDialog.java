package com.onekeyask.lawfirm.utils.dialog;
...
/**
 * Created by Weavey on 2016/9/4.a
 */
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.blackModule);
            rightButtonText = "确定";
            ...
            isTouchOutside = true;
            hintText = "";
            hintTextColor = ContextCompat.getColor(mContext, R.color.blackHint);
            lines = -1;
            maxLines = -1;
            maxLength = -1;
            height = 0.28f;
